...
2. **Sequence.** In `outputs/audit-progress.md`, Stage 2 (Line Item Audit) must be `Complete` or `Skipped`. If it isn't, refuse, point the user to `/claim-line-item-audit`, and stop.
