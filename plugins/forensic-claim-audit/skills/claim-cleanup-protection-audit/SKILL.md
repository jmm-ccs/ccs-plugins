...
2. **Sequence.** In `outputs/audit-progress.md`, Stage 9 (Storage, Debris & Disposal Audit) must be `Complete` or `Skipped`. If it isn't, refuse, point the user to `/claim-storage-debris-audit`, and stop.
