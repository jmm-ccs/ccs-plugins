...
2. **Sequence.** In `outputs/audit-progress.md`, Stage 4 (Related Items Audit) must be `Complete` or `Skipped`. If it isn't, refuse, point the user to `/claim-related-items-audit`, and stop.
