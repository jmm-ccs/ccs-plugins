...
2. **Sequence.** In `outputs/audit-progress.md`, Stage 5 (Type-of-Loss Audit) must be `Complete` or `Skipped`. If it isn't, refuse, point the user to `/claim-type-of-loss-audit`, and stop.
