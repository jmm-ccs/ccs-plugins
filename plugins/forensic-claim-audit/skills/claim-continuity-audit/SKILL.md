...
2. **Sequence.** In `outputs/audit-progress.md`, Stage 7 (Code, Ordinance & Law Audit) must be `Complete` or `Skipped`. If it isn't, refuse, point the user to `/claim-code-ordinance-law-audit`, and stop.
