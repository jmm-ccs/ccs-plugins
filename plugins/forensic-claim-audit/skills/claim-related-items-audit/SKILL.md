...
2. **Sequence.** In `outputs/audit-progress.md`, Stage 3 (Line Item Completeness Audit) must be `Complete` or `Skipped`. If it isn't, refuse, point the user to `/claim-line-item-completeness-audit`, and stop.
